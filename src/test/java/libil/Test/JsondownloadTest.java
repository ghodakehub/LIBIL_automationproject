...
public class JsondownloadTest extends BaseTest2{
	...
	public void VerifydownloadJSONoptions() throws InterruptedException, IOException {
		...
		Allure.step("Enter keyword in search and select exact search option");
		 JSOfileDownload test = new JSOfileDownload(driver);
		 Allure.step("click on downlaod json button and check is downloaded json file successfully");
	        test.downloadJSON("Pratiksha");
