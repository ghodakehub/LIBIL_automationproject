...
public class ScreenShotsUtility {
	...
	public static String addScreenshotToReport(WebDriver driver, String screenshotName) {
		captureScreenshotToReport(driver, screenshotName);
		return screenshotName;
	}

	// Static method to take a screenshot in screenshots
	public static String takeScreenshot(WebDriver driver,String screenshots) {
